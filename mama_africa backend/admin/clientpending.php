                      ...
                      <div class="btn-group" role="group">
                          ...
                          <a href="rejectedclients.php" type="button" class="btn btn-outline-primary">Rejected</a>
                            ...
                            <table class="table table table-bordered  " id="printTable" class="dataTables_filter">
                                ...
                                <tbody>
                                    <?php
                                    $select ="SELECT * FROM family_member WHERE  status='Pending'";
                                    $query=mysqli_query($con,$select);
                                    while($row=mysqli_fetch_array($query)){
                                        ?>
                                          <tr>
                                        <td>
                                            <a href="approve_account.php?get=<?php print $row['member_id']?>" class="btn btn-info btn-sm">
                                        Approve
                                        </a>
                                     
                                            <a href="reject_account.php?get=<?php print $row['member_id']?>" class="btn btn-primary btn-sm">
                                        Reject
                                        </a>
                                    </td>
