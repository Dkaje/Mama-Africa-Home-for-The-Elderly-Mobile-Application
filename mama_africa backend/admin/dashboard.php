...
<body class="bg-success">
    <div class="container-fluid position-relative d-flex p-0">
      ...
      include '../config/adminbar.php';
       ...
       ?>
            <!-- Navbar End -->
                       <h1 class="text-center"><?php print $siteName?></h1>
            ...
            <div class="container-fluid ">
                <div class="row ">
                      ...
                      <div class="col-sm-6 col-xl-3">
                        <a href="approved_clients.php">   <div class="bg-secondary rounded d-flex align-items-center justify-content-between p-4">
                            <i class="fa fa-users fa-3x text-white"></i>
                            <div class="ms-3">
                                <p class="mb-2 text-white">Users</p>
                    ...
                    <div class="col-sm-6 col-xl-3">
                       ...
                       <div class="bg-secondary rounded d-flex align-items-center justify-content-between p-4">
                            ...
                            <div class="ms-3">
                                <p class="mb-2 text-white">Staff</p>
                    ...
                    <div class="col-sm-6 col-xl-3">
                        <a href="lab_resuts.php">
                        <div class="bg-secondary rounded d-flex align-items-center justify-content-between p-4">
                            <i class="fa fa-chart-area fa-3x text-white"></i>
                            <div class="ms-3">
                            <p class="mb-2 text-white">Test results</p>
