                    ...
                    <div class="col-sm-12 col-xl-12 ">
                        ...
                        <div class="card rounded h-100 p-4  table-responsive">
                            ...
                            <div class="btn-group" role="group">
                                ...
                                <a href="#" type="button" class="btn btn-outline-primary">Rejected</a>
                            </div>
                            ...
                            <table class="table table-bordered" id="printTable" class="dataTables_filter">
                                ...
                                <tbody>
                                    ...
                                    RIGHT JOIN appointment a ON e.elder_id=a.elder_id WHERE  a.appointment_status='Attended'";
                                    $query=mysqli_query($con,$select);
                                    while($row=mysqli_fetch_array($query)){
                                        ?>
                                          <tr>
                                          <td scope="row">
                                            <a href="appointment_details.php?get=<?php print $row['appointment_id']?>">
                                        View
                                    </a>
                                </td>
