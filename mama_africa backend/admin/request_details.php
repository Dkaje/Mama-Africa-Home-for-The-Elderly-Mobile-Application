                ...
                <div class="row g-4">
                    ...
                    <div class="col-sm-12 col-xl-12 ">
                        ...
                        <div class="card rounded h-100 p-4  table-responsive">
                            ...
                            <table class="table table-bordered"  class="dataTables_filter">
                                <thead>
                                    <tr>
                                        <th scope="col">ID</th>
                                ...
                                <tbody>
                                    ...
                                    RIGHT JOIN requests r ON e.elder_id=r.elder_id WHERE  r.request_id='$requestID'";
                                ...
                                $select="SELECT * FROM item_requested ir INNER JOIN items i ON ir.item_id=i.item_id
                                 ...
                                 while($row=mysqli_fetch_array($query)){
                                    ...
                                    <tr>
                                        ...
                                        <td><?php print $row['request_details']?></td>
                                    </tr>
                                    <?php
                                 }
                                ?>
