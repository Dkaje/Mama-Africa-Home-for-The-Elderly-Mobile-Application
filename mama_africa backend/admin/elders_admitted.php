                ...
                <div class="row g-4">
                    ...
                    <div class="col-sm-12 col-xl-12 ">
                        ...
                        <div class="card rounded h-100 p-4  table-responsive">
                            <h6 class="text-dark ">Admitted elders</h6>
                            ...
                            <table class="table table-bordered" id="printTable" class="dataTables_filter">
                                ...
                                <tbody>
                                    <?php
                                    $select ="SELECT fm.first_name,fm.last_name,fm.phone_no,
                                    e.elder_id,e.firstname,e.lastname,e.dob,e.gender,e.date_added,s.f_name,s.l_name FROM family_member fm INNER JOIN elder e ON fm.member_id=e.member_id
                                    RIGHT JOIN care_giver cg ON e.elder_id=cg.elder_id RIGHT JOIN staff s ON cg.staff_id=s.staff_id
                                     WHERE  e.elder_status='Admitted'";
