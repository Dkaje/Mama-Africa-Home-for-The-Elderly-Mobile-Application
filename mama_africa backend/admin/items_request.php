                ...
                <div class="row g-4">
                    ...
                    <div class="col-sm-12 col-xl-12 ">
                        ...
                        <div class="card rounded h-100 p-4  table-responsive">
                            <h6 class="text-dark ">Item request</h6>
                            ...
                            <div class="btn-group" role="group">
                                ...
                                <a href="request_approved.php" type="button" class="btn btn-outline-primary">Approved</a>
                                <a href="items_request.php" type="button" class="btn btn-outline-primary">
                                    Pending approval
                                </a>
                                <a href="issued.php" type="button" class="btn btn-outline-primary">Issued</a>
                            ...
                            <table class="table table-bordered" id="printTable" class="dataTables_filter">
                                ...
                                <tbody>
                                    ...
                                    RIGHT JOIN requests r ON e.elder_id=r.elder_id WHERE  r.request_status='Pending approval'";
                                    $query=mysqli_query($con,$select);
                                    while($row=mysqli_fetch_array($query)){
                                        ?>
                                          <tr>
                                          <td scope="row"><?php print $row['request_id']?></td>
                                        ...
                                        <td><?php print $row['request_date']?></td>
                                        <td><?php print $row['request_status']?></td>
                                        <td><a href="request_details.php?get=<?php print $row['request_id']?>">View</a></td>
