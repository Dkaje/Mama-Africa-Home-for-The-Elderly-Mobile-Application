                      ...
                      <div class="btn-group" role="group">
                          ...
                          <a href="rejected_suppliers.php" type="button" class="btn btn-outline-primary">Rejected</a>
                            ...
                            <table class="table table table-bordered  " id="printTable" class="dataTables_filter">
                                ...
                                <tbody>
                                    <?php
                                    $select ="SELECT * FROM supplier WHERE  status='Pending'";
                                    $query=mysqli_query($con,$select);
                                    while($row=mysqli_fetch_array($query)){
                                        ?>
                                          <tr>
                                        <td>
                                            <a href="approve_supplier.php?get=<?php print $row['supplier_id']?>" class="btn btn-info btn-sm">
                                        Approve
                                        </a>
                                            <a href="reject_supplier.php?get=<?php print $row['supplier_id']?>" class="btn btn-primary btn-sm">
                                        Reject
                                        </a>
                                    </td>
