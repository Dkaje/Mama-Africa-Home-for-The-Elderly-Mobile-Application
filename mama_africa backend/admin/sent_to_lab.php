                    ...
                    <div class="col-sm-12 col-xl-12 ">
                        ...
                        <div class="card rounded h-100 p-4  table-responsive">
                            ...
                            <div class="btn-group" role="group">
                                ...
                                <a href="reports.php" type="button" class="btn btn-outline-primary">Report</a>
                            ...
                            <table class="table table-bordered" id="printTable" class="dataTables_filter">
                                ...
                                <tbody>
                                    ...
                                    RIGHT JOIN appointment a ON e.elder_id=a.elder_id WHERE  a.appointment_status='Sent to lab'";
